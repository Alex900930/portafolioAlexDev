       ...
       <div className='w-full max-w-3xl mx-auto md:pb-40 md:pt-20 '>
         <div className='-my-6'>
            {dataAboutPage.map((data)=>(
               <div key={data.id}
               className='relative py-6 pl-8 sm:pl-32 text-white group'
               >
                 <h3 className='mb-1 text-2xl font-bold sm:mb-0'>
                    {data.title}
                  </h3> 
                  <div
                  className='flex flex-col sm:flex-row item-start mb-1
                  group-last:before:hidden before:absolute before:left-2 
                  sm:before:left-0 before:h-full before:px-px before:bg-slate-300
                  sm:before:ml-[6.5rem]
                  ...
                  after:bg-indigo-600 after:border-4 after:box-content after:border-slate-50 
                  ...
                  >
                     ...
                     uppercase w-20 h-6 mb-3 sm:mb-0 text-emerald-600 bg-emerald-100
                     rounded-full
                     '>
                        {data.date}
                     </time>
