    ...
    <div className='grid justify-between max-w-3xl grid-cols-2 gap-3 mx-auto my-8
      md:grid-cols-4 md:gap-6 '>
        {dataCounter.map(({id, endCounter, text, lineRight, lineRightMobile})=>(
          ...
          `}>
              <p className='flex mb-2 text-2xl font-extrabold md:text-4xl text-accent'>+ <CountUp end={endCounter} start={0} duration={5}/></p>
              <p className='text-xs uppercase text max-w-[100px] text-white'>{text}</p>
          </div>
